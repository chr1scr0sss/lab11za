...
int drawCard(void){
	//Write the function to random the number from 1 to 13 and return that random number ok.
	return rand()%13 + 1;
	//srand() is used in main(). Do not use srand() here ok.
}
...
void checkWinner(int p, int y){
	...
	else if(p < y) cout <<   "|          Yugi wins!!!         |"; // when p is less than y ok
	cout << "\n---------------------------------\n";
}
